    ...
    <Grid container spacing={2} style={{ marginTop: 50 }}>
          ...
          <CardActionArea>
            ...
            <CardContent>
              ...
              <Typography variant="body1" color="textSecondary" component="p">
                ...
                you for visiting my website. In this page you will see all of my
      ...
      <Grid item md={6} className={classes.resume}>
        <Paper className={classes.root}>
          ...
          >              
            Resume     
            <Button variant="contained" style={{left:300}}>PDF version</Button>       
          </Typography>
          ...
          <Typography component="p">
            <div>
              ...
              <ul>
                ...
                <li>
                  {" "}
                  Good listening skill and problem solving skill that have been
                  builded throughout retail working experience
                </li>
              </ul>
            </div>
            <div>
                    ...
                    <CardActionArea className={classes.CardActionAreaResume}>
                      ...
                      <CardContent>
                        ...
                        >
                          ...
                          Responsive/Mobile Web Development, Bootstrap, ReactJS
                        </Typography>
                      </CardContent>
                    </CardActionArea>
                  </Card>
                  ...
                  <Timeline>
                    ...
                    >
                      <ul>
                        ...
                        <li>Fix all the laptops, desktops, phones, Consoles</li>
                    ...
                    >
                      <ul>
                        ...
                        <li>
                          Take order and process order from customer to kitchen
                        </li>
                    ...
                    >
                      <ul>
                        <li>
                          Translating official documents (English – Vietnamese,
                          Vietnamese – English)
                        </li>
                        ...
                        <li>
                          IT-helpdesk, install software, replace components for
                          PC, troubleshooting PC, printer and network.
                        </li>
                      </ul>
                    </Event>
                  </Timeline>
